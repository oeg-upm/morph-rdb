...
public class RunnerFactory {
	...
	private static R2RMLRunner createR2RMLRunnerC(ConfigurationProperties configurationProperties)
			throws Exception {
	...
	private static R2RMLRunner createR2RMLRunnerE(ConfigurationProperties configurationProperties)
			throws Exception {
		R2RMLRunner r2rmlRunner = new R2RMLRunner(configurationProperties);
		r2rmlRunner.buildQueryTranslator();
		IQueryTranslator queryTranslator = r2rmlRunner.getQueryTranslator();
	...
	private static R2RMLRunner createR2RMLRunnerFC(ConfigurationProperties configurationProperties)
			throws Exception {
		R2RMLRunner r2rmlRunner = new R2RMLRunner(configurationProperties);
		r2rmlRunner.buildQueryTranslator();
		IQueryTranslator queryTranslator = r2rmlRunner.getQueryTranslator();
