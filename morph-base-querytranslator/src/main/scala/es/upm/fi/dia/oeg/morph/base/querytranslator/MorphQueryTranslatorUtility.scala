...
object MorphQueryTranslatorUtility {
  ...
  def mapsIntersection(map1:Map[Node, Set[AbstractConceptMapping]] , map2:Map[Node, Set[AbstractConceptMapping]]) 
  ...
  def mapsIntersection(maps:List[Map[Node, Set[AbstractConceptMapping]]]) 
  : Map[Node, Set[AbstractConceptMapping]] = {
		  val result : Map[Node, Set[AbstractConceptMapping]] = {
