...
class MorphQueryRewriter(mapNodeLogicalTableSize:Map[Node, java.lang.Long], reorderSTG:Boolean)
extends Rewrite {
...
object MorphQueryRewriter {
	def apply(mapNodeLogicalTableSize:java.util.Map[Node, java.lang.Long], reorderSTG:Boolean) = {
	  new MorphQueryRewriter(mapNodeLogicalTableSize.toMap, reorderSTG);
	}
}
