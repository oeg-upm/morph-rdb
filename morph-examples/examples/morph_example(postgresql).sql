...
COPY "Sport" ("ID", "Name", "Code", "Type") FROM stdin;
100	Tennis	TNS     	BOTH    
...
COPY "Student" ("ID", "Name", "Sport", "Status", "Webpage", "Phone", "Email", "Suffix", "Birthdate") FROM stdin;
B1      	Paul	100	active	\N	777-3426	\N	Jr.	2000-12-31
B2      	John	200	active	\N	\N	john@acd.edu	Sr.	\N
B3      	George	300	active	www.george.edu	\N	\N	Sr. 	1990-06-18
B4      	Ringo	\N	active	www.starr.edu	888-4537	ringo@acd.edu	Jr. 	\N
\.
